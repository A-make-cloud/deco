...
/**
 * Servlet implementation class Livraisonok
 */
@WebServlet("/Livraisonok")
public class Livraisonok extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher( "/Livraisonok.jsp" ).forward( request, response );
	}
