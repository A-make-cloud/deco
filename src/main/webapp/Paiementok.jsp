        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-md-6 text-center text-md-left">
                    <h1 class="mb-4 mb-md-0 text-primary text-uppercase">Votre reglement</h1>
                </div>
  ...
  <section class="contact_section layout_padding">
    ...
    <div class="container">
            ...
            <%--  <h4>Total : ${panier.quantite() } </h4> --%>
               <h4>Cher(e) Madame / Monsieur ${usernom }</h4>
              
              <h1 style="text-align:center;">Nous avons reçu votre reglement<br> Votre commande est en cours de livraison.</h1>
                <center>
               <h4>Votre référence client ${id_Client }</h4>
                 <h4>Total : ${panier.total() } €</h4>
                 <h4>Adresse de livraison: ${useradresse }</h4>
                 </center>
              <center>
              <a href="Livraisonok"><img style="margin-top:150px;" src="img/emballage.png"><span><p>Suivez Votre livraison avec votre numéro de traçage:<%--  ${cdme:trackingNbre } --%></p></span></a>
